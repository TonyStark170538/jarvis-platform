...
export interface SecurityIocContext { ioc: SecurityIoc; events: SecurityEvent[]; detections: DetectionResult[]; incidents: SecurityIncident[]; attackTechniques: string[]; firstSeen?: string; lastSeen?: string; matchReasons: string[]; }
